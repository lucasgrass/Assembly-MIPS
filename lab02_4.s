...
sw $ra, 0($sp)				    # Armazena o conteúdo do registrador $ra 
								...
								#seria necessário guardá-los na pilha também, e restaurá-los ao fim do procedimento. 
								# Por convenção, os registradores temporários $t* não precisam ser guardados.
li $t1, 1 						# $t1 = 1
...
mflo $v0 						# resultado em $v0
								# Obs:. O resultado da instrução mult fica armazenado nos registradores # $hi e $lo. 
								#Para buscar os seus valores, utiliza-se mflo e mfhi. 
								#Para # podermos trabalhar com valores maiores em nosso programa bastaria retornar o $lo em $v0 e o $hi em $v1.
jr $ra							# Retorna	